...
public class BrainItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public BrainItem(Properties props, int humanityCost) {
        super(props);
    ...
    public boolean dropsOnDeath(ItemStack installedStack, CyberwareSlot slot) {
        return RandomSource.create().nextFloat() < 0.05F;
    }
}