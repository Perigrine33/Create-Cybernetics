...
public class RightLegItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public RightLegItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.RIGHTLEG_REPLACEMENTS);
    }
