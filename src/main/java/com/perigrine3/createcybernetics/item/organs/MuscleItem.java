...
public class MuscleItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public MuscleItem(Properties props, int humanityCost) {
        super(props);
    ...
    public boolean dropsOnDeath(ItemStack installedStack, CyberwareSlot slot) {
        return RandomSource.create().nextFloat() < 0.07F;
    }
}