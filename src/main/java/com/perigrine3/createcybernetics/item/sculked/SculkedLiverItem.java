...
public class SculkedLiverItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public SculkedLiverItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.LIVER_ITEMS);
    }
