...
public class SculkedRightLegItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public SculkedRightLegItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.RIGHTLEG_ITEMS);
    }

    @Override
    public Set<CyberwareSlot> getSupportedSlots() {
        return Set.of(CyberwareSlot.RLEG);
    }
