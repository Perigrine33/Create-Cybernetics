...
public class SculkedLeftLegItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public SculkedLeftLegItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.LEFTLEG_ITEMS);
    }
