...
public class SculkedRightArmItem extends Item implements ICyberwareItem {
    private final int humanityCost;

    public SculkedRightArmItem(Properties props, int humanityCost) {
        super(props);
    ...
    public Set<TagKey<Item>> incompatibleCyberwareTags(ItemStack installedStack, CyberwareSlot slot) {
        return Set.of(ModTags.Items.RIGHTARM_ITEMS);
    }
