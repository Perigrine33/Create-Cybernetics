...
public class ModGlobalLootModifierProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        this.add("trial_chamber_vault_claws",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/ominous_trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.ARMUPGRADES_CLAWS.get()));
        ...
        this.add("trial_chamber_vault_rarm",
                new AddItemModifier(new LootItemCondition[]{
                        ...
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.BASECYBERWARE_RIGHTARM.get()));
        this.add("trial_chamber_vault_larm",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.BASECYBERWARE_LEFTARM.get()));
        this.add("trial_chamber_vault_redshard",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.DATA_SHARD_RED.get()));
        this.add("trial_chamber_vault_flywheel",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.ARMUPGRADES_FLYWHEEL.get()));
        this.add("trial_chamber_vault_wrist",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.ARMUPGRADES_PNEUMATICWRIST.get()));
        this.add("trial_chamber_vault_jumpboost",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.05f).build()}, ModItems.LEGUPGRADES_JUMPBOOST.get()));
        this.add("trial_chamber_vault_bonelacing",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.BONEUPGRADES_BONELACING.get()));
        this.add("trial_chamber_vault_boneflex",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.BONEUPGRADES_BONEFLEX.get()));
        this.add("trial_chamber_vault_matrix",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.BRAINUPGRADES_MATRIX.get()));
        this.add("trial_chamber_vault_subdermalarmor",
                new AddItemModifier(new LootItemCondition[]{
                        new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("vault/trial_chamber")).build(),
                        LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.SKINUPGRADES_SUBDERMALARMOR.get()));
...
//ARCHEOLOGY (SUS SAND & SUS GRAVEL)
        {
            ...
            this.add("trail_ruins_common_datura",
                    new AddItemModifier(new LootItemCondition[]{
                            new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("archaeology/trail_ruins_common")).build(),
                            LootItemRandomChanceCondition.randomChance(0.05f).build()}, ModItems.DATURA_SEED_POD.get()));
...
//END CITY TREASURE
            {
                ...
                if (ModItems.SCAVENGED_NAVIGATIONCHIP != null) {
                    this.add("end_city_treasure_navigationchip",
                            new AddItemModifier(new LootItemCondition[]{
                                    new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("chests/end_city_treasure")).build(),
...
//NETHER BRIDGE
            {
                ...
                if (ModItems.SCAVENGED_NAVIGATIONCHIP != null) {
                    this.add("nether_bridge_navigationchip",
                            new AddItemModifier(new LootItemCondition[]{
                                    new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("chests/nether_bridge")).build(),
                                    LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.SCAVENGED_NAVIGATIONCHIP.get()));
                }
...
//STRONGHOLD CORRIDOR
            {
                ...
                if (ModItems.SCAVENGED_NAVIGATIONCHIP != null) {
                    this.add("stronghold_corridor_navigationchip",
                            new AddItemModifier(new LootItemCondition[]{
                                    new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("chests/stronghold_corridor")).build(),
                                    LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.SCAVENGED_NAVIGATIONCHIP.get()));
                }
                ...
                if (ModItems.SCAVENGED_CONSCIOUSNESSTRANSMITTER != null && ModItems.SCAVENGED_CORTICALSTACK != null) {
                    this.add("stronghold_corridor_consciousnesstransmitter",
                            new AddItemModifier(new LootItemCondition[]{
                                    new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("chests/stronghold_corridor")).build(),
                                    LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.SCAVENGED_CONSCIOUSNESSTRANSMITTER.get()));
                    this.add("stronghold_corridor_corticalstack",
                            new AddItemModifier(new LootItemCondition[]{
                                    new LootTableIdCondition.Builder(ResourceLocation.withDefaultNamespace("chests/stronghold_corridor")).build(),
                                    LootItemRandomChanceCondition.randomChance(0.1f).build()}, ModItems.SCAVENGED_CORTICALSTACK.get()));
                }
