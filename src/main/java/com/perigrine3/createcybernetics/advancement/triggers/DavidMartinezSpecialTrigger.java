...
public final class DavidMartinezSpecialTrigger extends SimpleCriterionTrigger<DavidMartinezSpecialTrigger.Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player)
        ...
        public static Criterion<Instance> any() {
            return ModCriteria.DAVID_SPECIAL.get()
