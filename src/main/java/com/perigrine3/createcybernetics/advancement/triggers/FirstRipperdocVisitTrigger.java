...
public final class FirstRipperdocVisitTrigger extends SimpleCriterionTrigger<FirstRipperdocVisitTrigger.Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player)
        ...
        public static Criterion<Instance> any() {
            return ModCriteria.FIRST_RIPPERDOC_VISIT.get()
