...
public final class FirstScavengedCyberwareTrigger extends SimpleCriterionTrigger<FirstScavengedCyberwareTrigger.Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player)
        ...
        public static Criterion<Instance> any() {
            return ModCriteria.FIRST_SCAVENGED_CYBERWARE.get()
