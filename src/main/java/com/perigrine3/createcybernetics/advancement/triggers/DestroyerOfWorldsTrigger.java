...
public final class DestroyerOfWorldsTrigger extends SimpleCriterionTrigger<DestroyerOfWorldsTrigger.Instance> {
    ...
    public record Instance(Optional<ContextAwarePredicate> player)
        ...
        public static Criterion<Instance> any() {
            return ModCriteria.DESTROYER_OF_WORLDS.get()
